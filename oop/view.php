...
<div class="container">
    <div class="page-header">
        <h1><a href="/mysql/">Game</a></h1>
    </div>

    <!-- CRUD List -->

    <div style="width: 700px; height: 400px; background: #eee; position: relative;">
        <?php $obj->render()?>
    </div>
    ...
    <div>
        <h2>Actions</h2>
        <form method="get">
            <input type="checkbox" name="red" value="1" <?php if (isset($_GET['red'])) echo " checked";?>/>
